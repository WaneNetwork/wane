...
1. GitHub private vulnerability reporting. Go to the Security tab of the repository at https://github.com/WaneProtocol/wane-base and click "Report a vulnerability". This opens a private advisory visible only to maintainers.
